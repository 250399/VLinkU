...
$sql="SELECT * FROM registration_details WHERE email='$id'";
...
$result=mysqli_query($conn,"select * from profilepic where email='$_SESSION[EmailID]'");
...
echo "<br/>";
echo '<tr><td>email  </td>';
echo '<td> : '.$_SESSION['EmailID'].'</td> </tr>';
echo "<br/>";
...
$email=$UserID;
$result2=mysqli_query($conn,"select * from profilepic where email ='$_SESSION[EmailID]'");
$res2=mysqli_fetch_array($result2);

$result=mysqli_query($conn,"select * from problem_stmt where email ='$_SESSION[EmailID]'");
